...
import 'package:farmers_ecommerce2/commons/loading.dart';
import 'package:farmers_ecommerce2/db/order.dart';
import 'package:farmers_ecommerce2/models/cart_item.dart';
import 'package:farmers_ecommerce2/pages/payment.dart';
                ...
                child: Row(
                  children: <Widget>[
                    ClipRRect(
                      ...
                      child: Image.network(
                        userProvider.userModel.cart[index].image[0],
                        height: 120,
                        width: 140,
                        fit: BoxFit.fill,
                      ),
